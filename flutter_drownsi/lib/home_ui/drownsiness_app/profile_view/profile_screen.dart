...
import 'package:flutter_drownsi/home_ui/drownsiness_app/ui_view/logout_button_view.dart';
  ...
  void addAllListData() {
    ...
    listViews.add(
      ButtonToLogout(
        ...
        animationController: widget.animationController,
        buttonLogout: FlatButton(onPressed: ()=>{
            AuthClass().signOut(),
            ...
            MaterialPageRoute(builder: (context) => LoginPage()),
              ...
              color: HexColor("#f01d1d"),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  Icon(Icons.subdirectory_arrow_left, color: Colors.white,),
                  Text('Sign out',textAlign: TextAlign.left, style: TextStyle(color: Colors.white),)
                ],
              ),
        ),
      ),
